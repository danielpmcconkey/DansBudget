...
exports.handler = async (event, context) => {
    ...
    const debt_account_id = (event.pathParameters == undefined) ? undefined : event.pathParameters['debt-account-id'];
    ...
    if (loggedInUSer == null || loggedInUSer == undefined || loggedInUSer === "") {
        ...
        try {
            ...
            responseBody = `Unable to get debt accounts: ${err}`;
            statusCode = 403;
        }
    }
    const response = {
